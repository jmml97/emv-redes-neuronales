...
En el proceso de comunicación entre dos neuronas distinguimos entre la neurona \textit{presinóptica}, la emisora, y la nuerona \textit{postsinóptica}, la receptora.
Para el envío de una señal la neurona presinóptica envía neurotransmisores a través del axón a un conjunto de moléculas receptoras en la neurona postsinóptica.
Este envío suele ocurrir en periodos de tiempo de duración aleatoria, pero la ratio de envío depende de muchos factores, entre ellos, la intensidad de la señal de <<entrada>> a la neurona presinóptica.
